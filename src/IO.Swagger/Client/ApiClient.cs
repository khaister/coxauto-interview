...
namespace IO.Swagger.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("http://api.coxauto-interview.com");
        }
        ...
        public ApiClient(String basePath = "http://api.coxauto-interview.com")
        {
        ...
        public FileParameter ParameterToFile(string name, Stream stream)
        {
            return stream is FileStream
                ? FileParameter.Create(name, ReadAsBytes(stream), Path.GetFileName(((FileStream)stream).Name))
